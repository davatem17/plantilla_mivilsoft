...
import 'package:plantilla_mivilsoft/src/widgets/camera_widget.dart';
import 'package:plantilla_mivilsoft/src/widgets/home_widget.dart';
...
List<ItemMenu> menuOptions = [
  ...
  ItemMenu(Icons.videocam, "Cámaras")
];

List<Widget> contentWidget = [HomeWidget(), Camera()];
